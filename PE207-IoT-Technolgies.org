...
- Apply various machine learning and data analytics techniques for IoT
  applications (K3)
- Use security aspects in designing real time IoT applications (K3).
- Build an IoT application to solve a real world problem in teams by
