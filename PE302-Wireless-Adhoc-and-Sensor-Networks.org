* PE302 <<<WIRELESS ADHOC AND SENSOR NETWORKS>>>
:properties:
...
- Select various Transport layer protocols and QOS in ad hoc networks as per requirements(K4)
- Select different topologies and routing protocols based on the application requirement in WSN (K4)
- Choose appropriate localisation and routing protocols for the given scenario in WSN (K4)
- Choose appropriate networking approach, transport layer protocol and QoS in WSN (K4)
- Simulate the functionality of protocols for wireless adhoc or Sensor networks using a Simulator (K4) 
