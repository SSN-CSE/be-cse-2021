...
| Course mapping |   3 |   3 |   2 |   2 |   0 |   0 |   0 |   1 |   1 |    1 |    0 |    1 |    3 |    0 |    0 |
...
- Distinguish different types of environments and agents (K2)
- Identify, formulate and solve AI problems using search techniques
  (K3)
- Represent knowledge using logic and solve AI problems using
  inference in logic (K3)
- Represent uncertain knowledge using probability and solve AI
  problems using probabilistic reasoning (K3)
